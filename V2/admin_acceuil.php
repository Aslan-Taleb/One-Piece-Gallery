...
d’afficher le détail de son profil. */
    ...
    if ($_SESSION['role'] == 'A') {
        ...
        if ($resultat_donnes == false) {
            ...
            echo  "<tr>";
            echo ('<th>' . "cpt_pseudo" . '</th>');
            echo ('<th>' . "cpt_mot_de_passe" . '</th>');
            echo ('<th>' . "pfl_nom" . '</th>');
            echo ('<th>' . "pfl_prenom" . '</th>');
            echo ('<th>' . "pfl_mail" . '</th>');
            echo ('<th>' . "pfl_role" . '</th>');
            echo ('<th>' . "pfl_validite" . '</th>');
            echo ('<th>' . "pfl_date" . '</th>');
            ...
            if ($resultat_donnes == false) {
                ...
                while ($donnes = $resultat_donnes->fetch_assoc()) {
                    echo  "<tr>";
                    echo ('<td>' . $donnes['cpt_pseudo'] . '</td>' . '<td>' . $donnes['cpt_mot_de_passe'] . '</td>');
                    echo ('<td>' . $donnes['pfl_nom'] . '</td>' . '<td>' . $donnes['pfl_prenom'] . '</td>' . '<td>' . $donnes['pfl_mail'] . '</td>');
                    echo ('<td>' . $donnes['pfl_role'] . '</td>' . '<td>' . $donnes['pfl_validite'] . '</td>' . '<td>' . $donnes['pfl_date'] . '</td>');
